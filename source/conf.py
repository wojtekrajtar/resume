...
html_theme_options["social"][1].update({
            "icon": "fontawesome/brands/github",
            "link": "https://github.com/wrajtar",
        },
)

html_theme_options["social"][0].update({
            "icon": "fontawesome/brands/linkedin",
            "link": "https://www.linkedin.com/in/wojtek-rajtar-08b179157/",
        },
)
